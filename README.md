...
```vue
<template>
  <button class="hll-button" :class="btnClass">
    <slot></slot>  
  </button>
</template>
<script>
...
```vue
<template>
  <button class="hll-button" :class="btnClass" :disabled="loading">
    <hll-icon :icon="icon" v-if="icon && !loading" class="icon"></hll-icon>
    <hll-icon icon="loading" v-if="loading" class="icon loading"></hll-icon>
    <span v-if="this.$slots.default">
      <slot></slot>
    </span>
  </button>
...
​```html
<div>
    <hll-button>默认按钮</hll-button>
    <hll-button type="primary">主要按钮</hll-button>
    <hll-button type="success">成功按钮</hll-button>
    <hll-button type="info">信息按钮</hll-button>
    <hll-button type="warning">警告按钮</hll-button>
    <hll-button type="danger">危险按钮</hll-button>
</div>
​```
:::
</demo-block>
